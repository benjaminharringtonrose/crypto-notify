...
export const STRATEGY_CONFIG = {
  ...
  SLIPPAGE: 0.001,
  COMMISSION: 0.1,
  STOP_LOSS_MULTIPLIER_DEFAULT: 8,
  TRAILING_STOP_DEFAULT: 0.25,
  MIN_HOLD_DAYS_DEFAULT: 8,
  BUY_PROB_THRESHOLD_DEFAULT: 0.2, // Lowered from 0.25
  SELL_PROB_THRESHOLD_DEFAULT: 0.3,
  MOMENTUM_WINDOW_THRESHOLD: 0.01,
  MAX_ATR_THRESHOLD: 0.15,
  MIN_PROFIT_THRESHOLD: 0.005,
  MOMENTUM_THRESHOLD: 0.015, // Lowered from 0.02
  VOLATILITY_ADJUSTED_MOMENTUM_THRESHOLD: 0.03, // Lowered from 0.04
  TREND_STRENGTH_THRESHOLD: 0.0004, // Lowered from 0.0005
  DEVIATION_THRESHOLD: 0.015, // Increased from 0.01
  VOLUME_MULTIPLIER: 1.5,
  TREND_SLOPE_THRESHOLD: 0.008, // Lowered from 0.01
  SHORT_MOMENTUM_THRESHOLD: 0.008, // Lowered from 0.01
  DAYS_SINCE_TRADE_THRESHOLD: 15,
  DYNAMIC_BREAKOUT_THRESHOLD: 0.25, // Lowered from 0.3
  HIGH_CONFIDENCE_THRESHOLD: 0.65,
  MOMENTUM_MULTIPLIER: 0.05,
  MAX_PROFIT_TAKE: 4.0,
  NEGATIVE_MOMENTUM_THRESHOLD: -0.04,
  NEGATIVE_SHORT_MOMENTUM_THRESHOLD: -0.015,
  MEAN_REVERSION_THRESHOLD: 0.015, // Increased from 0.01
  NEGATIVE_SHORT_MOMENTUM_MIN: -0.01,
  MOMENTUM_MAX: 0.025,
  POSITION_SIZE_MAX: 0.03,
  POSITION_SIZE_MAX_HIGH_ATR: 0.15,
  POSITION_SIZE_MAX_HIGH_CONFIDENCE: 0.15, // Reduced from 0.2
  ...
  NEGATIVE_DEVIATION_THRESHOLD: -0.015, // Tightened from -0.01
  ...
  MEAN_REVERSION: {
    MIN_CONFIDENCE_DEFAULT: 0.25,
    BUY_PROB_THRESHOLD_DEFAULT: 0.25,
    MIN_HOLD_DAYS_DEFAULT: 5,
    PROFIT_TAKE_MULTIPLIER_DEFAULT: 3,
    STOP_LOSS_MULTIPLIER_DEFAULT: 6,
    TRAILING_STOP_DEFAULT: 0.2,
    VOLATILITY_ADJUSTED_MOMENTUM_THRESHOLD: 0.02,
    TREND_STRENGTH_THRESHOLD: 0.0002,
  },
  BREAKOUT: {
    MIN_CONFIDENCE_DEFAULT: 0.28,
    BUY_PROB_THRESHOLD_DEFAULT: 0.2,
    MIN_HOLD_DAYS_DEFAULT: 7,
    STOP_LOSS_MULTIPLIER_DEFAULT: 7,
    TRAILING_STOP_DEFAULT: 0.2,
    PROFIT_TAKE_MULTIPLIER_DEFAULT: 4,
    VOLATILITY_ADJUSTED_MOMENTUM_THRESHOLD: 0.04, // Lowered from 0.05
