...
export const MODEL_CONSTANTS = {
  TIMESTEPS: 30,
  FEATURE_COUNT: 61,
  MIN_CONFIDENCE_DEFAULT: 0.58, // Increased from 0.55
  PROFIT_TAKE_MULTIPLIER_DEFAULT: 3.0,
  BASE_POSITION_SIZE_DEFAULT: 0.08,
  SLIPPAGE: 0.001,
  COMMISSION: 0.1,
  STOP_LOSS_MULTIPLIER_DEFAULT: 2.5, // Reduced from 3.0
  TRAILING_STOP_DEFAULT: 0.06, // Reverted from 0.05
