...
export const MODEL_CONSTANTS = {
  ...
  VOLATILITY_ADJUSTED_MOMENTUM_THRESHOLD: 0.2,
  ...
  DYNAMIC_BREAKOUT_THRESHOLD: 0.7,
  HIGH_CONFIDENCE_THRESHOLD: 0.7,
  MOMENTUM_MULTIPLIER: 0.05,
  MAX_PROFIT_TAKE: 4.0,
  NEGATIVE_MOMENTUM_THRESHOLD: -0.03,
  NEGATIVE_SHORT_MOMENTUM_THRESHOLD: -0.01,
...
export const MODEL_ARCHITECTURE_CONSTANTS = {
  ...ARCHITECTURE_BASE,
  LSTM1_INPUT_FEATURES: ARCHITECTURE_BASE.CONV1D_FILTERS_2,
  CONV1D_1_WEIGHT_SHAPE: [
    ARCHITECTURE_BASE.CONV1D_KERNEL_SIZE_1,
    MODEL_CONSTANTS.FEATURE_COUNT,
    ARCHITECTURE_BASE.CONV1D_FILTERS_1,
  ] as [number, number, number],
  CONV1D_2_WEIGHT_SHAPE: [
    ARCHITECTURE_BASE.CONV1D_KERNEL_SIZE_2,
    ARCHITECTURE_BASE.CONV1D_FILTERS_1,
    ARCHITECTURE_BASE.CONV1D_FILTERS_2,
  ] as [number, number, number],
  LSTM1_WEIGHT_SHAPE: [
    ARCHITECTURE_BASE.CONV1D_FILTERS_2,
    ARCHITECTURE_BASE.LSTM_UNITS_1 * 4,
  ] as [number, number],
  LSTM1_RECURRENT_SHAPE: [
    ARCHITECTURE_BASE.LSTM_UNITS_1,
    ARCHITECTURE_BASE.LSTM_UNITS_1 * 4,
  ] as [number, number],
  LSTM2_WEIGHT_SHAPE: [
    ARCHITECTURE_BASE.LSTM_UNITS_1,
    ARCHITECTURE_BASE.LSTM_UNITS_2 * 4,
  ] as [number, number],
  LSTM2_RECURRENT_SHAPE: [
    ARCHITECTURE_BASE.LSTM_UNITS_2,
    ARCHITECTURE_BASE.LSTM_UNITS_2 * 4,
  ] as [number, number],
  LSTM3_WEIGHT_SHAPE: [
    ARCHITECTURE_BASE.LSTM_UNITS_2,
    ARCHITECTURE_BASE.LSTM_UNITS_3 * 4,
  ] as [number, number],
  LSTM3_RECURRENT_SHAPE: [
    ARCHITECTURE_BASE.LSTM_UNITS_3,
    ARCHITECTURE_BASE.LSTM_UNITS_3 * 4,
  ] as [number, number],
  TIME_DISTRIBUTED_WEIGHT_SHAPE: [
    ARCHITECTURE_BASE.LSTM_UNITS_3,
    ARCHITECTURE_BASE.TIME_DISTRIBUTED_DENSE_UNITS,
  ] as [number, number],
  DENSE_1_WEIGHT_SHAPE: [
    ARCHITECTURE_BASE.TIMESTEPS_AFTER_CONV *
      ARCHITECTURE_BASE.TIME_DISTRIBUTED_DENSE_UNITS,
    ARCHITECTURE_BASE.DENSE_UNITS_1,
  ] as [number, number],
  DENSE_2_WEIGHT_SHAPE: [
    ARCHITECTURE_BASE.DENSE_UNITS_1,
    ARCHITECTURE_BASE.OUTPUT_UNITS,
  ] as [number, number],
};
...
export const TIMESTEP_IN_SECONDS =
  MODEL_CONSTANTS.TIMESTEPS * ONE_DAY_IN_SECONDS;
