...
- **Features**: 26 (Optimized from 36 features through gradual feature optimization)
- **Parameters**: ~35K
- **Training Time**: ~73 seconds (35 epochs)
...
- **Batch Size**: 16
- **Epochs**: 35 (early stopping at epoch 27)
- **Data**: 730 days, threshold=0.001, horizon=1
...
✅ **Stable Architecture**: 26-feature capacity without overfitting  
